/*
 * $Id: ASLBoardPicker.java 9199 2015-05-28 11:27:08Z swampwallaby $
 *
...
//      eParse.printStackTrace();
    ...
    protected class Cropper extends JDialog implements ActionListener {
        ...
        private void init() {
            ...
            bdName = new JComboBox(getBoards());
            box.add(bdName);
    ...
    protected class TerrainEditor extends JDialog implements ActionListener {
        ...
        private JComboBox bdName = new JComboBox();
